    ...
    public static class VariantCodec
    {
        ...
        private static object DecodeScalarValue(BinaryDecoder decoder, VariantType type)
        {
            return type switch
            {
                ...
                VariantType.NodeId => NodeIdCodec.Decode(decoder),
                VariantType.ExpandedNodeId => ExpandedNodeIdCodec.Decode(decoder),
        ...
        private static Type GetElementType(VariantType type)
        {
            return type switch
            {
                ...
                VariantType.NodeId => typeof(NodeId),
                VariantType.ExpandedNodeId => typeof(ExpandedNodeId),
